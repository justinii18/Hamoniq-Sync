...
public enum HarmoniqSyncMethod: String, CaseIterable, Sendable {
    ...
    public static func recommended(for contentType: AudioContentType) -> HarmoniqSyncMethod {
        switch contentType {
...
extension HarmoniqSyncMethod {
    public func toSyncEngineMethod() -> SyncEngine.HarmoniqSyncMethod {
        switch self {
        case .spectralFlux: return .spectralFlux
...
extension HarmoniqSyncConfiguration {
    public func toSyncEngineConfiguration() -> SyncEngine.HarmoniqSyncConfiguration {
        return SyncEngine.HarmoniqSyncConfiguration(
...
extension SyncEngine.AlignmentResult {
    public func toHarmoniqSyncResult() -> AlignmentResult {
